...
async function triggerAd(timeType) {
    ...
    // অ্যাড ভিডিওতে কন্ট্রোল পুরোপুরি বন্ধ এবং টাচ ডিজেবল করা হয়েছে
    ...
    adVid.controls = false; // নিশ্চিত করতে যে কন্ট্রোল আসবে না
    ...
    // নেটওয়ার্ক স্লো থাকলে বা বাফারিং করলে লোডার দেখানো
    adVid.onwaiting = () => {
        if(!document.getElementById('ad-initial-loader')){
            root.insertAdjacentHTML('afterbegin', `<div class="full-screen-loader" id="ad-initial-loader"><div class="spinner"></div></div>`);
        }
    };
    ...
    adVid.onloadedmetadata = () => {
        adVid.ontimeupdate = () => {
            // ইউজারের জোর করে টানা (Seeking) বন্ধ করার লজিক
            if (adVid.seeking) { adVid.currentTime = adVid.played.end(0); }
            
            // ৮০% শেষ হলে স্কিপ বাটন
